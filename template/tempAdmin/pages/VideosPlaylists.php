...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../index.html" class="brand-link">
      <img src="../dist/img/esmLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">ESM</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="VideosPlaylists.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="listaTVs.php" class="nav-link">
              <i class="fas fa-tv"></i>
              <p>
                Lista de TVs
              </p>
...
require __DIR__ . '/../../../BD/autoload.php';
...
$table->setTemplate("../../../BD/classes/db/TableBD.html");
