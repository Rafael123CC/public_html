...
$table->setFieldsAtive("id, idLayout, x, y, larg, alt, PlaylistID",'list');
$table->setFieldsAtive("idLayout, x, y, larg, alt, PlaylistID", 'new');
$table->setFieldsAtive("idLayout, x, y, larg, alt, PlaylistID", 'edit');
$table->setFieldsAtive("idLayout, x, y, larg, alt, PlaylistID", 'csv');
